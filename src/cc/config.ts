...
export const waitTime = 1500 // milliseconds
...
export const growthLimit = 0.99;
export const pctToHack = 0.20;
export const attackTimeAllowedOnRaisedSecurity = 1 // seconds
